        ...
        @endif
            ...
            <form class="form-horizontal mt-3" method="POST" action="{{ route('verification.send') }}">
                ...
                <div class="form-group mb-3 text-center row mt-3 pt-1">
                    <div class="col-12">
                        <button class="btn btn-info w-100 waves-effect waves-light" type="submit">     {{ __('Resend Verification Email') }}</button>
                    </div>
                </div>
            </form>
            ...
            <form method="POST" action="{{ route('logout') }}">
                ...
                <div class="form-group mb-3 text-center row mt-3 pt-1">
                    <div class="col-12">
                        <button class="btn btn-info w-100 waves-effect waves-light" type="submit">  {{ __('Log Out') }}</button>
                    </div>
                </div>
            </form>
                        </div>
